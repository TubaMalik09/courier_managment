...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 08, 2025 at 12:24 PM
...
INSERT INTO `addcourier` (`id`, `sender-name`, `sender-email`, `sender-phone`, `sender-address`, `receiver-name`, `receiver-email`, `receiver-phone`, `receiver-address`, `parcel-info`, `weight`, `time-record`, `price`, `tax`, `total`, `trackingno`, `service-id`, `branch`) VALUES
(6, 'Hasad Johnston', 'havyfema@mailinator.com', '+1 (756) 412-6755', 'Temporibus ab dolore', 'Sigourney Marshall', 'jurule@mailinator.com', '+1 (512) 457-1376', 'Autem vero sunt quo ', 'Quos aliquid similiq', '0', '2025-09-08 ', 399, 63.84, 462.84, '', 3, 17),
(7, 'Kessie Garner', 'zuhy@mailinator.com', '+1 (638) 445-6801', 'Earum alias duis nih', 'Buffy Livingston', 'gabyluw@mailinator.com', '+1 (708) 946-2786', 'Et accusamus volupta', 'Enim explicabo Dign', '0', '2025-09-08 ', 399, 63.84, 462.84, 'TRK-20250908-2B746D', 3, 18),
(8, 'Blythe Levine', 'gyxun@mailinator.com', '+1 (743) 669-9291', 'Consequat Illum si', 'Xaviera Compton', 'wohybaqaje@mailinator.com', '+1 (925) 329-4063', 'Vero autem inventore', 'Deserunt molestias i', '0', '2025-09-08 ', 500, 80, 580, 'TRK-20250908-B73C19', 2, 17);
...
CREATE TABLE `courierstatus` (
  ...
  `recordtime` varchar(100) NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(4, 'documents', 'hausgawuigdaw', 200, 2147483647),
(5, 'by weight', 'lskLAK', 500, 2147483647);
...
--
-- AUTO_INCREMENT for table `courierstatus`
--
ALTER TABLE `courierstatus`
...
--
-- Constraints for table `courierstatus`
--
ALTER TABLE `courierstatus`
  ADD CONSTRAINT `courierstatus_ibfk_1` FOREIGN KEY (`trackingno`) REFERENCES `addcourier` (`id`);
COMMIT;
