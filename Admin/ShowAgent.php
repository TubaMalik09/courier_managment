...
.table {
  ...
  font-size: 15px;
  margin: 15px 0;   /* space around table */
}
...
.btn {
  ...
  margin: 2px;   /* little spacing between buttons */
}
...
.modal-content {
  ...
  margin-top: 60px;  /* modal not stuck at top */
}
...
.modal-body select {
  ...
  margin-bottom: 16px;
  font-size: 14px;
  line-height: 1.4;       /* balance vertical alignment */
...
.modal-body input::placeholder {
  color: #888;
  line-height: normal;    /* reset placeholder alignment */
}
    ...
    <div class="card shadow-sm">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle" id="a">
                ...
                <tbody>
                    <?php
                    $run = mysqli_query($conn, "SELECT * FROM agent");
                    if ($run && mysqli_num_rows($run) > 0) {
                        while ($row = mysqli_fetch_array($run)) {
                            ...
                            <tr>
                                ...
                                <td><?php $_fetchbranch = mysqli_fetch_array(mysqli_query($conn, 
                                "select * from branch where id = $row[6]"
                        ...
                        ?></td> 
                                ...
                                <td><a href="DeleteAgent.php?id=<?php echo $row[0]; ?>" class="btn btn-danger">Delete</a></td>
                            </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Agent  </h1>
...
<select name="f" id="branch" class="form-control">
