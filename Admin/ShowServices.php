    ...
    <div class="card shadow-sm">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle"  id="a">
                ...
                <tbody>
                    <?php
                    $run = mysqli_query($conn, "SELECT * FROM service");
                    if ($run && mysqli_num_rows($run) > 0) {
                        while ($row = mysqli_fetch_array($run)) {
                            ...
                            <tr>
                                ...
                                <td><a href="DeleteServices.php?id=<?php echo $row[0]; ?>" class="btn btn-danger">Delete</a></td>
                            </tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="UpdateServices.php" method="POST">
            ...
            <label for="name">Title</l0abel>
            <input type="text" placeholder="Title" class="form-control" value="<?php echo $row[1] ?>" name="a">
            <label for="desc">Description</label>
            <input type="" placeholder="Description" class="form-control" value="<?php echo $row[2] ?>" name="b">
            <label for="name">Price</label>
            <input type="text" placeholder="Price" class="form-control" value="<?php echo $row[3] ?>" name="c">
