                    ...
                    if ($run && mysqli_num_rows($run) > 0) {
                        while ($row = mysqli_fetch_array($run)) {
                            ...
                            <tr>
                                ...
                                <td><a href="DeleteProfile.php?id=<?php echo $row[0]; ?>" class="btn btn-danger">Delete</a></td>
                            </tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="UpdateProfile.php" method="POST">
            ...
            <input type="text" placeholder="Password" class="form-control" value="<?php echo $row[3] ?>" name="c">
            <br>
